...
Given a **Directed Acyclic __13__Graph (DAG)** with `V` vertices (numbered `0` to `V-1`) and an adjacency list `adj`, find a **topological ordering** of the vertices using the BFS-based approach known as **Kahn's Algorithm**.
