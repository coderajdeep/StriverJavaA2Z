...
__10__Greedy approach: compute the value/weight ratio for every item, sort items in decreasing order of this ratio, and greedily pick items (taking a fraction of the last item if it doesn't fully fit) until the knapsack capacity is exhausted.
